...
function CartData() {
  const { cartItem, removeFromCart, food_list, getCartTotal } =
  ...
  return (
    <>
      {getCartTotal() > 0 ? (
        <div className="p-10">
          ...
          <div className="flex justify-between mt-28 gap-[10vw] total_cart">
            <div className="cart-total">
              ...
              <button className="mt-3 text-white font-bold bg-[tomato] py-3 px-7 rounded-lg hover:opacity-90 active:scale-95 text-[10px] sm:text-[16px]">
                PROCEED TO CHECKOUT
              </button>
            </div>
            {/* // promo code */}
        ...
        <div className="text-[5vw] text-center mt-10 font-bold">
